...
function cargos(carg){
    localStorage.setItem('cargos', carg);
}
if (carg = null){
    carg = "";
}; 

var baseurl = 'http://ua-appweb02:8090/DataSnap/Rest/TServerMethods1/Colaboradores/0/0/';

// var baseurl = 'http://ua-dev:8080/DataSnap/Rest/TServerMethods1/Colaboradores/0/0/';

function loadColab(){
    var xmlhttp = new XMLHttpRequest();
    var cargo = localStorage.getItem('cargos')
    xmlhttp.open("GET", baseurl + cargo, false);
    localStorage.clear();
                                ...
                                <div class="card medium waves-effect hoverable">
                                    ...
                                    <div class="card-reveal lime accent-4">
                                        ...
                                        <p style="color: black;"><br>
                                            <b>Unidade ` + colab[i].equipe_filial + ` </b><br><br>
                                            <b>Matricula: </b>` + colab[i].equipe_matricula + `<br><br>
